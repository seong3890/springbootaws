...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = -2033499903L;
    ...
    public final ListPath<OrderList, QOrderList> orderLists = this.<OrderList, QOrderList>createList("orderLists", OrderList.class, QOrderList.class, PathInits.DIRECT2);
